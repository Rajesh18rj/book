...
<head>
  ...
  <title>Log in | Scientific International Publishing House</title>
...
<div class="login-box">    
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <img src="dist/img/favicon.png" alt="Logo" class="" style="max-width: 50%; display: block; margin: 0 auto; padding-bottom: 10px;">
      <p class="login-box-msg text-dark">Welcome To SIP</p>
