...
if (file_exists('class/product_class.php')) {
...
</svg>  <i class="bi bi-plus-circle"></i> Add Product </button>
                </a>
                            ...
                            <table  id="example" class="table table-striped table-bordered">                  
                                ...
                                ?>
                                            ...
                                            <tr>
                                                <td><?php echo $i++ ?> </td>
                                                <td>
                                                <img src = "uploads/product_images/<?php echo $data['imagelist']; ?>" width = "56px"
                                                height= "50px">  
                                                
                                                </td>
                                                <td><?php echo $data['name'] ?> </td>
                                                <td><?php echo $data['sqft_price'] ?> </td>
                                                <td><?php 

                                                      $fetch = new Product();
                                                      $fetchdatas = $fetch->fetch_category();
                                                      foreach($fetchdatas as $fetchdata){

                                                        if($data["category"] == $fetchdata["id"]){
                                                          echo $fetchdata['category_name'];
                                                        }else{
                                                ...
                                                <a href="edit_product.php?id=<?php echo $data['id'] ?>"  class="edit_class">
